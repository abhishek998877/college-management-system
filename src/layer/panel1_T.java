 ...
 * @author Abhishek
 */
public class panel1_T extends javax.swing.JPanel {
  ...
  String reg_str;
    ...
    public panel1_T(String reg_ob) throws SQLException {
        initComponents();
        reg_str=reg_ob;
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new Attendance_T(reg_str).setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(panel1_T.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
