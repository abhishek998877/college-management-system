 ...
 * @author Abhishek
 */
public class sem5_u extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sem5_u.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
