 ...
 * @author Abhishek
 */
public class sem1_u extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sem1_u.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
