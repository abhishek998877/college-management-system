 ...
 * @author Abhishek
 */
public class sem4_u extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sem4_u.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
